...
<pre>documentObject.getSelection();</pre>
...
thisDocument.contentControls.items.length;
...
| Parameter | Type | Description |
| --- | --- | --- |
| myparam | object | Optional. Accepts parameter and relationship names as delimited string or an array. Or, provide [loadOption](loadoption.md) object. |
